...
class Bittrex(object):
    ...
    def get_tick_history(self, market, tickInterval):
        request_url = 'https://bittrex.com/Api/v2.0/pub/market/GetTicks?'
        options = {'marketName':market, 'tickInterval':tickInterval, '_':'1499127220008'}
        request_url += urlencode(options)
        apisign = hmac.new(''.encode(),
                           request_url.encode(),
                           hashlib.sha512).hexdigest()
        return using_requests(request_url, apisign)